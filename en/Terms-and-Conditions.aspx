<%@ Page Title="Terms of Use :nshama" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Terms-and-Conditions.aspx.cs" Inherits="Nshama.Web.en.Terms_and_Conditions" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <section class="contact">
   <img src="/img/content/contact-bg.jpg" alt="" />
   <div class="center-content">
    ...
    <div class="terms-detail">
     ...
     <p>
      This website is owned and operated by Nshama LLC (“Nshama” "Company", "we" or "us"). The following terms and conditions, the lease or sale and purchase agreement (“Property Agreement”) entered into with the Company or any of its affiliates pertaining to a commercial lease, unit or plot in a Nshama project in respect of which this website is used together with any documents they expressly incorporate by reference (collectively, these "Terms of Use"), govern your access to and use of www.nshamallc.com (the "Website"), including any content, functionality and services offered on or through the Website whether as a guest or a registered user
     </p>
     <p>
      Please read the Terms of Use carefully before you start to use the Website. By using the Website or, where applicable, by clicking to accept or agree to the Terms of Use when this option is made available to you, you accept and agree to be bound and abide by these Terms of Use and our Privacy Policy, found at www.nshamallc.com, incorporated herein by reference. If you do not want to agree to these Terms of Use or the Privacy Policy, you must not access or use the Website.
     </p>
     <h5>
     ...
     <p>
      ...
      <p>
       In respect of requests for technical support and other communications relating to the Website, you can contact us by using our website contact form, or by emailing us at www.nshamallc.com.
      </p>
      <p>
       For feedback or suggestions, please contact us on www.nshamallc.com.
      </p>
      <p>
