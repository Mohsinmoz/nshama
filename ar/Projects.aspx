...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <section class="ts-main" id="home" data-anchor="top">
  ...
  <div class="home-copy">
   ...
   <p>   
    ...
    destination in itself and allows you to<br />
 ...
 <section class="ts-lifestyle" id="lifestyle">
  ...
  <div class="copy-block">
   ...
   <div class="more">
    <p>
     Relish in the choice and flavours of life among 1.3 kilometers of cafés, shops, restaurants and other boutiques. All within easy walking distance of your home. 
    </p>
   </div>
  </div>
 </section>
 <section class="ts-square" id="square">
  ...
  <div class="copy-block">
   ...
   <div class="more">
    <p>
     Perfect for a quick get together at the heart of our development. Take lunch or spend a whole afternoon in the central park. With interactive water features, a shaded public plaza and plenty of cafés there’s something for everybody.
    </p>
   </div>
  </div>
 </section>
 <section class="ts-home" id="ts-home">
  ...
  <div class="copy-block">
   <div class="block-head zahra">
    ...
    <a href="/town-square/zahra-townhouses">Zahra Townhouses</a>
    <a href="/town-square/hayat-townhouses">Hayat Townhouses</a>
   </div>
  </div>
 </section>
